...
const $mainNavigation=document.querySelector(".main-navigation");console.log($mainNavigation);let backToTop=0;window.addEventListener("scroll",()=>{const o=window.scrollY;o>=600&&!backToTop?(console.log("Para baixo"),$mainNavigation.classList.add("scrolleffect"),backToTop=!backToTop):o<=600&&backToTop&&(console.log("Para cima"),backToTop=!backToTop)});

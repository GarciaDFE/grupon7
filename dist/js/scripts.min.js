...
const $wrapHeader=document.querySelector(".wrap-header");let backToTop=0;window.addEventListener("scroll",()=>{const o=window.scrollY;o>=600&&!backToTop?($wrapHeader.classList.add("scrolleffect"),backToTop=!backToTop):o<=600&&backToTop&&($wrapHeader.classList.remove("scrolleffect"),backToTop=!backToTop)});

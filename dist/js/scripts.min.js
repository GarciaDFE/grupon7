...
const $originServices=document.querySelector(".-originservices"),$originPartners=document.querySelector(".-originpartners"),$wrapServices=document.querySelector(".wrap-services"),$wrapPartners=document.querySelector(".wrap-partners"),$btnV1=document.querySelector(".-v1"),$btnV2=document.querySelector(".-v2");let $view=0,breakPhone=599;$originServices.addEventListener("click",function(){($view=window.innerWidth)>breakPhone&&smoothScroll($wrapServices,1e3)}),$originPartners.addEventListener("click",function(){smoothScroll($wrapPartners,2e3)}),$btnV1.addEventListener("click",function(){smoothScroll($originServices,5e3)}),$btnV2.addEventListener("click",function(){smoothScroll($originServices,6e3)});const smoothScroll=(e,r)=>{const n=e.getBoundingClientRect().top,t=window.pageYOffset,o=n-t;let i=null;const c=e=>{null===i&&(i=e);const n=e-i,l=s(n,t,o,r);window.scrollTo(0,l),n<r&&requestAnimationFrame(c)},s=(e,r,n,t)=>(e/=t/2)<1?n/2*e*e+r:-n/2*(--e*(e-2)-1)+r;requestAnimationFrame(c)};

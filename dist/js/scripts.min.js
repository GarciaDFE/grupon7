...
const $wrapHeader=document.querySelector(".wrap-header");let backToTop=0;window.addEventListener("scroll",()=>{const o=window.scrollY;o>=200&&!backToTop?($wrapHeader.classList.add("scrolleffect"),backToTop=!backToTop):o<=200&&backToTop&&($wrapHeader.classList.remove("scrolleffect"),backToTop=!backToTop)});
const $originServices=document.querySelector(".-originservices"),$originPartners=document.querySelector(".-originpartners"),$originFooter=document.querySelector(".-originfooter"),$Services=document.querySelector(".wrap-services"),$Partners=document.querySelector(".wrap-partners"),$Contacts=document.querySelector(".main-footer"),$btnV1=document.querySelector(".-v1"),$btnV2=document.querySelector(".-v2");let $view=0,breakPhone=599;$originServices.addEventListener("click",function(){($view=window.innerWidth)>breakPhone&&smoothScroll($Services,1e3)}),$originPartners.addEventListener("click",function(){smoothScroll($Partners,2e3)}),$originFooter.addEventListener("click",function(){smoothScroll($Contacts,2e3)}),$btnV1.addEventListener("click",function(){smoothScroll($originServices,2e3)}),$btnV2.addEventListener("click",function(){smoothScroll($originServices,2e3)});let navbarFixHeight=100;const smoothScroll=(e,o)=>{const n=e.getBoundingClientRect().top,t=window.pageYOffset,r=n-(t+navbarFixHeight);let i=null;const c=e=>{null===i&&(i=e);const n=e-i,l=s(n,t,r,o);window.scrollTo(0,l),n<o&&requestAnimationFrame(c)},s=(e,o,n,t)=>(e/=t/2)<1?n/2*e*e+o:-n/2*(--e*(e-2)-1)+o;requestAnimationFrame(c)};
